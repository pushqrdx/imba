(function(){
	...
	Func.prototype.js = function (o){
		...
		var yields = this.option('generator');
		...
		var out = ("function" + (yields ? ('*') : ('')) + name + "(" + (this.params().c()) + ") ") + code;
	...
	function Yield(){ Call.apply(this,arguments) };
	
	subclass$(Yield,Call);
	exports.Yield = Yield; // export class 
	Yield.prototype.visit = function (){
		if (this.args()) { this.args().traverse() };
		var fn = this.stack().up(Func);
		fn.option('generator',true);
		return this;
	};
	
	Yield.prototype.js = function (){
		return this.args() && this.args().realCount() ? (("yield " + (this.args().c({expression: true})))) : ("yield");
	};

...
TagTypeIdentifier.prototype.isSimple = function (){
	return (/input|textarea|select|form|iframe/).test(this._str);
};
...
Tag.prototype.isSimple = function (){
	return (this.type() instanceof TagTypeIdentifier) && this.type().isSimple();
};
...
Tag.prototype.js = function (jso){
	...
	var isImbaTag = (!(this.isSelf()) && !(this.isNative()) && !(this.isSimple()));
